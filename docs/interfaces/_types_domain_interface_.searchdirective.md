[node-beget](../README.md) › [Globals](../globals.md) › ["types/domain.interface"](../modules/_types_domain_interface_.md) › [SearchDirective](_types_domain_interface_.searchdirective.md)
